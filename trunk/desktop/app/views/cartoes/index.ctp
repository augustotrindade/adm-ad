...
<table cellpadding="0" cellspacing="0">
		<tr>
			...
			<th width="120px"><?php echo $paginator->sort('sequencial');?></th>
			<th><?php echo $paginator->sort('Pessoa','Pessoa.nome');?></th>
			<th width="120px"><?php echo $paginator->sort('Tipo Cartão','Modelocartao.Tipopessoa.nome');?></th>
		...
		?>
			<tr <?php echo $class;?>>
				<td>
					<?php echo $cartao['Cartao']['id']; ?>
				</td>
				<td>
					<?php echo $cartao['Cartao']['sequencial']; ?>
				</td>
				<td>
					<?php echo $cartao['Pessoa']['nome']; ?>
				</td>
				<td>
					<?php echo $cartao['Modelocartao']['Tipopessoa']['nome']; ?>
				</td>
				<td class="actions">
					<?php echo $html->link(__('Editar', true), array('action'=>'edit', $cartao['Cartao']['id'])); ?>
					<?php echo $html->link(__('Excluir', true), array('action'=>'delete', $cartao['Cartao']['id']), null, sprintf(__('Tem certeza que deseja excluir o item # %s?', true), $cartao['Cartao']['id'])); ?>
				</td>
			</tr>
		<?php endforeach; ?>
	</table>
